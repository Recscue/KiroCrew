...
window.fetch = ((input: RequestInfo | URL, init?: RequestInit) => {
  ...
  // The modal's pre-open reachability probe. It is a real API route with no
  // gateway behind this page, so without an answer here the dialog never opens
  // and the capture photographs an empty viewport.
