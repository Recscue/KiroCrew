...
_OAUTH_AUTHORIZATION_ENDPOINTS: frozenset[tuple[str, str]] = frozenset(
    {
        ...
        # Mixpanel is the same shape: the issuer is the MCP host
        # (mcp.mixpanel.com/mcp) while the consent page lives on mixpanel.com.
        ("mcp.mixpanel.com", "/oauth/authorize"),
